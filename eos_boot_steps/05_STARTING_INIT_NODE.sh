...
# TOKEN_AMOUNT="1000000000.0000"
TOKEN_AMOUNT="\"1000000000.0000 DAC\""
# TOKEN_AMOUNT2="\"1000.0000 DAC\""
# TOKEN_SYMBOL="DAC"
...
# ./cleos.sh push action $INIT_ACCOUNT create '{"issuer":'$INIT_ACCOUNT',"maximum_supply":'$TOKEN_AMOUNT'}' -p $INIT_ACCOUNT

# ./cleos.sh push action $INIT_ACCOUNT create '{"issuer":'$INIT_ACCOUNT',"maximum_supply":"1000000000.0000 DAC"}' -p $INIT_ACCOUNT
...
# echo push action $INIT_ACCOUNT create '{"issuer":'$INIT_ACCOUNT',"maximum_supply":'$TOKEN_AMOUNT'}' -p $INIT_ACCOUNT
...
# ./cleos.sh push action $INIT_ACCOUNT issue '{"to":'$INIT_ACCOUNT',"quantity":'${TOKEN_AMOUNT}',"memo":"issue DAPP token"}' -p $INIT_ACCOUNT

./cleos.sh system regproducer $INIT_ACCOUNT $INIT_PUB_KEY "1.5000 DAC" https://ibct.io/ -p $INIT_ACCOUNT
